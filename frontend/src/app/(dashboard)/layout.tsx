    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        /* ── MOBILE: no sidebar offset, bottom padding for navbar ── */
      ...
      <div style={{
        ...
        {/* Background orbs */}
        {[
          { w:600, h:600, style:{top:'-150px', left:'-150px'},    color:'rgba(99,102,241,0.18)', anim:'float-1 18s ease-in-out infinite' },
          { w:500, h:500, style:{bottom:'-100px', right:'-100px'},color:'rgba(139,92,246,0.15)', anim:'float-2 22s ease-in-out infinite' },
          { w:350, h:350, style:{top:'40%', left:'40%'},           color:'rgba(236,72,153,0.08)', anim:'float-3 26s ease-in-out infinite 4s' },
        ].map((o, i) => (
          <div key={i} style={{
